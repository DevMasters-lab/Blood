...
<div class="space-y-6 animate-fade-in px-8 py-8">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h2 class="text-2xl font-black text-gray-900 tracking-tight">KYC Verifications</h2>
            <p class="text-sm text-gray-500 font-medium mt-1">Review official IDs to verify donors and secure the platform.</p>
        </div>
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($pendingUsers as $user)
                        <tr class="hover:bg-gray-50/50 transition-colors group">
                            ...
                            <td class="px-8 py-6">
                                <p class="text-sm font-bold text-blue-600">{{ $user->email ?? 'N/A' }}</p>
                            </td>
                            <td class="px-8 py-6">
